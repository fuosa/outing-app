    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        ...
        {(isFormOpen || editingId !== null) && (
          <div className={`rounded-2xl p-4 shadow-sm mb-4 border-2 ${
            editingId !== null 
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="font-semibold text-gray-800">
                {editingId !== null ? "スポットを編集中" : "新しいスポットを追加"}
              </h3>
            </div>
            <input
              type="text"
            ...
            <div className="flex gap-2 mt-3">
              <button
                onClick={editingId !== null ? handleUpdateSpot : handleAddSpot}
                className={`text-white px-4 py-2 rounded-lg text-sm flex-1 font-medium ${
                  editingId !== null ? "bg-amber-500" : "bg-blue-500"
                }`}
              >
                {editingId !== null ? "変更を保存する" : "追加する"}
              </button>
              <button
                onClick={() => {
                  setIsFormOpen(false)
